...
SUBROUTINE KP_RK4(RES,NSTEP,NSTRIDE,DT,PHI0,PSI0,T0,ALPHA,BETA)
    ...
    DO I=1,NSTRIDE
        DO J=1,NSTEP
            ...
            PHI1=PSIOLD*DT
            PSI2=KP(PHIOLD+HALF_F32*PHI1,T+HALF_F32*DT,ALPHA,BETA)*DT
            PHI2=(PSIOLD+HALF_F32*PSI1)*DT
            PSI3=KP(PHIOLD+HALF_F32*PHI2,T+HALF_F32*DT,ALPHA,BETA)*DT
            PHI3=(PSIOLD+HALF_F32*PSI2)*DT
            PSI4=KP(PHIOLD+PHI3,T+DT,ALPHA,BETA)*DT
            PHI4=(PSIOLD+PSI3)*DT
            PHI=PHIOLD+SIXTH*(PHI1+2.0_F32*PHI2+2.0_F32*PHI3+PHI4)
            IF(PHI.GT.PI_F32) PHI=PHI-PI2
            IF(PHI.LE.-PI_F32) PHI=PHI+PI2
            PSI=PSIOLD+SIXTH*(PSI1+2.0_F32*PSI2+2.0_F32*PSI3+PSI4)
            T=T+DT
            PHIOLD=PHI
            PSIOLD=PSI
        ENDDO
