...
LSTF:=fdefs.f90 data_buf.f90 vec3d.f90 tsurf.f90  lpl_gf.f90 linalg.f90
# C library sources
...
LSTBF:=data_buf_tst.f90 lpl_bem_tst.f90 lpl_bem1_tst.f90 #mk_sphere.f90 cmp_tsurf.f90
# C program sources
